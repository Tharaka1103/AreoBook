...
<head>
    ...
    <title>Areobook - Flight Search</title>
    ...
    <style>
        ...
        .expiry-cvv select, .expiry-cvv input {
            width: 30%;
        }
    </style>
</head>
<body>
    ...
    <main>
        ...
        <section class="flights-grid">
            ...
            <div class="flight-card" data-price="<?php echo $flight['price']; ?>" data-airline="<?php echo $flight['airline']; ?>">
                <img src="images/<?php echo $flight['img']; ?>.jpg" alt="Flight <?php echo $flight['id']; ?>">
    ...
    <footer class="site-footer">
        ...
        <div class="footer-bottom">
            <p>© 2024 Areobook. All rights reserved.</p>
        </div>
    </footer>
